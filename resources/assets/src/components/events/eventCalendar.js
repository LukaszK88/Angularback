...
class MyCalendar extends Component{
                    ...
                    <List.Item key={attendance.id}>
                        ...
                        <List.Content>
                            ...
                            <List.Header>
                                ...
                                <Countdown targetDate={new Date(attendance.event.date)}
                                           format={{
                                               day: 'DD',
                                               hour: 'HH',
                                               minute: 'MM',
    ...
    render(){
        let bg ='';
        if(this.props.currentUser.user.club_id == '1'){
            bg = 'wc-bg'
        }
        if (this.props.currentUser.user.club_id == '2'){
            bg = 'ukfed-bg'
        }
        if (this.props.currentUser.user.club_id == '6'){
            bg = 'bad-bg'
        }
