...
class ChangePassword extends Component{
    ...
    render(){
        ...
        return(
            <Modal closeIcon size={'mini'} open={this.state.modalOpen}  onClose={this.handleClose} trigger={<button type="button" onClick={this.handleOpen} >Change password <Icon name="key"/></button>}>
