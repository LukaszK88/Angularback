  ...
  render() {
    ...
    return (
      <form onSubmit={handleSubmit(this.onSubmit.bind(this))}>
        ...
        />
        <Button.Group>
          <Button color="black" type="submit">Join</Button>
          <Button.Or />
              ...
              render={({ isLoading, isWorking, onClick }) => (
                <span onClick={onClick}>
                  <Button color="facebook">
                    <Icon name="facebook" /> Join with FB
                  </Button>
                </span>
                            )}
            />
...
export default withRouter(reduxForm({ validate, form: 'signupFighterForm' })(connect(mapStateToProps, {
  registerUser, addFlashMessage, loginWithFacebook, loading,
})(SignupFighter)));
