...
class Longsword extends Component {
  renderFighters() {
    ...
    const fighters = _.orderBy(this.props.fighters, ['longswordTable.points'], ['desc']);
...
export default connect(mapStateToProps)(Longsword);
