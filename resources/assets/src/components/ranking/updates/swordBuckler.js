...
class UpdateSwordBuckler extends Component{
    ...
    onSubmit(values){
        ...
        this.props.updateRanking(values,'sword_buckler');
...
export default withRouter(reduxForm({validate:validate, form: 'UpdateSwordShield'})(connect(null,{updateRanking})(UpdateSwordBuckler)));