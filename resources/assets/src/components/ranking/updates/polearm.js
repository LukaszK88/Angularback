...
class UpdatePolearm extends Component{
    ...
    onSubmit(values){
        ...
        this.props.updateRanking(values,'polearm');
...
export default withRouter(reduxForm({validate:validate, form: 'UpdateSwordShield'})(connect(null,{updateRanking})(UpdatePolearm)));