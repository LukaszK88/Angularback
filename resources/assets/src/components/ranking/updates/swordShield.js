...
class UpdateSwordShield extends Component{
    ...
    onSubmit(values){
        ...
        this.props.updateRanking(values,'sword_shield');
...
export default withRouter(reduxForm({validate:validate, form: 'UpdateSwordShield'})(connect(null,{updateRanking})(UpdateSwordShield)));